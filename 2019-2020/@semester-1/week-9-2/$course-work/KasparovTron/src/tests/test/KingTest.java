...
public class KingTest extends MainTest {
    ...
    static void testKingMoveSingleRow() {
        ...
        boolean isMoveValid = kingReference.isMoveValid(new PiecePosition(3,  2));
    ...
    static void testKingMoveSingleColumn() {
        ...
        Piece kingReference = new King(PieceColor.BLACK, 2, 2);
        boolean isMoveValid = kingReference.isMoveValid(new PiecePosition(2,  3));
        assertIsTrue(isMoveValid);
    }
    ...
    static void testKingMoveDiagonaly() {
        ...
        Piece kingReference = new King(PieceColor.BLACK, 2, 2);
        boolean isMoveValid = kingReference.isMoveValid(new PiecePosition(3,  3));
        assertIsTrue(isMoveValid);
    }
    ...
    static void testFailKingMoveTwoSquares() {
        ...
        Piece kingReference = new King(PieceColor.BLACK, 2, 2);
        boolean isMoveInValid = kingReference.isMoveValid(new PiecePosition(4,  2));
