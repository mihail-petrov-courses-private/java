...
<body>
    ...
    <h2>Servlet message : ${forward_message}</h2>
    <h2>Servlet message : ${demo_message}</h2>
...
//        }
        ...
        if(collection != null) {
            out.print("<h1>Error message collection</h1>");
    ...
    <a href="registration">Forward to this page</a>
